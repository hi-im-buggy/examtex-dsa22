...
void listAppend(list *self, void *data); // add an element at the end of the list
void listInsertAt(list *self, unsigned index, void *data); // insert an element at given index
void listDeleteAt(list *self, unsigned index); // delete an element at the given index
void *listAt(list *self, unsigned index);		 // return a pointer to element at an index
